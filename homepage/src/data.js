...
export const aboutDec = [
  {
    aboutMe:
      "다양한 프로젝트를 경험하면서 사용자 중심의 디자인과 최적화된 사용자 경험을 추구해 왔습니다. 기술적 도전에 직면했을 때, 문제를 명확하게 분석하고 적절한 해결책을 찾아내는 데 집중합니다. 이러한 과정에서 창의적이고 혁신적인 접근을 추구하여, 사용자가 진정으로 필요로 하는 솔루션을 개발하는 데 주력합니다. 지속적인 학습과 성장을 통해 개발자로서의 역량을 지속적으로 향상시키고, 새로운 기술 트렌드를 주시하며 도전적인 프로젝트에 도전하고 있습니다. 문제 해결과 결정적인 실행을 통해 프로젝트의 성과를 극대화하며, 팀과 함께 목표를 달성하는 데 기여하고자 합니다.",
  },
  {
    skill: [
